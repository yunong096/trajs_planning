...
#ifndef PROTOBUF_modules_2fplanning_2fplanning_5fbase_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto__INCLUDED
#define PROTOBUF_modules_2fplanning_2fplanning_5fbase_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto__INCLUDED
...
class QpSplineSmootherConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.QpSplineSmootherConfig) */ {
 ...
 private:
  ...
  friend struct protobuf_modules_2fplanning_2fplanning_5fbase_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
inline void DiscretePointsSmootherConfig::set_allocated_cos_theta_smoothing(::apollo::planning::CosThetaSmootherConfig* cos_theta_smoothing) {
  clear_SmootherConfig();
...
inline void DiscretePointsSmootherConfig::set_allocated_fem_pos_deviation_smoothing(::apollo::planning::FemPosDeviationSmootherConfig* fem_pos_deviation_smoothing) {
  clear_SmootherConfig();
...
inline void ReferenceLineSmootherConfig::set_allocated_discrete_points(::apollo::planning::DiscretePointsSmootherConfig* discrete_points) {
  clear_SmootherConfig();
  if (discrete_points) {
    set_has_discrete_points();
...
template <> struct is_proto_enum< ::apollo::planning::DiscretePointsSmootherConfig_SmoothingMethod> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_modules_2fplanning_2fplanning_5fbase_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto__INCLUDED
