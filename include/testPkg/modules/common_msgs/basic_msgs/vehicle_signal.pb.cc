...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/basic_msgs/vehicle_signal.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
VehicleSignal::VehicleSignal()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto::InitDefaults();
  }
  SharedCtor();
