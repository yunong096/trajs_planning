...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/basic_msgs/geometry.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
PointENU::PointENU()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fbasic_5fmsgs_2fgeometry_2eproto::InitDefaults();
  }
  SharedCtor();
