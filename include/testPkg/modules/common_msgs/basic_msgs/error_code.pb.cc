...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/basic_msgs/error_code.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
StatusPb::StatusPb()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fbasic_5fmsgs_2ferror_5fcode_2eproto::InitDefaults();
  }
  SharedCtor();
