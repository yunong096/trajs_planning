...
#ifndef PROTOBUF_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fdecision_2eproto__INCLUDED
#define PROTOBUF_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fdecision_2eproto__INCLUDED
...
inline void ObjectMotionType::set_allocated_static_(::apollo::planning::ObjectStatic* static_) {
  clear_motion_tag();
  if (static_) {
    set_has_static_();
...
inline void ObjectMotionType::set_allocated_dynamic(::apollo::planning::ObjectDynamic* dynamic) {
  clear_motion_tag();
  if (dynamic) {
    set_has_dynamic();
...
inline void ObjectDecisionType::set_allocated_side_pass(::apollo::planning::ObjectSidePass* side_pass) {
  clear_object_tag();
  if (side_pass) {
    set_has_side_pass();
...
template <> struct is_proto_enum< ::apollo::planning::MainParking_ParkingStatus> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fdecision_2eproto__INCLUDED
