...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/planning_msgs/sl_boundary.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  _SLBoundary_default_instance_._instance.DefaultConstruct();
...
SLBoundary::SLBoundary()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fsl_5fboundary_2eproto::InitDefaults();
  }
  SharedCtor();
...
void SLBoundary::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, this->boundary_point(static_cast<int>(i)), output);
  }
