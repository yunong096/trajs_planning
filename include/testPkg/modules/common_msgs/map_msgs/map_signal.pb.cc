...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  2,
  1,
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SignInfo, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SignInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SignInfo, type_),
  0,
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Signal, sign_info_),
  0,
  1,
  ~0u,
  ~0u,
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/map_msgs/map_signal.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Subsignal_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Subsignal_default_instance_);_SignInfo_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_SignInfo_default_instance_);_Signal_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Signal_default_instance_);_Subsignal_default_instance_._instance.get_mutable()->id_ = const_cast< ::apollo::hdmap::Id*>(
      ::apollo::hdmap::Id::internal_default_instance());
  _Subsignal_default_instance_._instance.get_mutable()->location_ = const_cast< ::apollo::common::PointENU*>(
      ::apollo::common::PointENU::internal_default_instance());
  _Signal_default_instance_._instance.get_mutable()->id_ = const_cast< ::apollo::hdmap::Id*>(
      ::apollo::hdmap::Id::internal_default_instance());
  _Signal_default_instance_._instance.get_mutable()->boundary_ = const_cast< ::apollo::hdmap::Polygon*>(
...
Subsignal::Subsignal()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fsignal_2eproto::InitDefaults();
  }
  SharedCtor();
...
// optional .apollo.hdmap.SignInfo.Type type = 1;
bool SignInfo::has_type() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void SignInfo::set_has_type() {
  _has_bits_[0] |= 0x00000001u;
}
void SignInfo::clear_has_type() {
  _has_bits_[0] &= ~0x00000001u;
}
void SignInfo::clear_type() {
  type_ = 0;
  clear_has_type();
}
::apollo::hdmap::SignInfo_Type SignInfo::type() const {
  // @@protoc_insertion_point(field_get:apollo.hdmap.SignInfo.type)
  return static_cast< ::apollo::hdmap::SignInfo_Type >(type_);
}
void SignInfo::set_type(::apollo::hdmap::SignInfo_Type value) {
...
void Signal::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      7, this->sign_info(static_cast<int>(i)), output);
  }
...
// repeated .apollo.hdmap.SignInfo sign_info = 7;
int Signal::sign_info_size() const {
  return sign_info_.size();
}
void Signal::clear_sign_info() {
  sign_info_.Clear();
}
const ::apollo::hdmap::SignInfo& Signal::sign_info(int index) const {
  // @@protoc_insertion_point(field_get:apollo.hdmap.Signal.sign_info)
  return sign_info_.Get(index);
}
::apollo::hdmap::SignInfo* Signal::mutable_sign_info(int index) {
  // @@protoc_insertion_point(field_mutable:apollo.hdmap.Signal.sign_info)
  return sign_info_.Mutable(index);
}
::apollo::hdmap::SignInfo* Signal::add_sign_info() {
