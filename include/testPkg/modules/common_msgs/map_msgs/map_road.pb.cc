...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/map_msgs/map_road.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  _BoundaryEdge_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_BoundaryEdge_default_instance_);_BoundaryPolygon_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_BoundaryPolygon_default_instance_);_RoadBoundary_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RoadBoundary_default_instance_);_RoadROIBoundary_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RoadROIBoundary_default_instance_);_RoadSection_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RoadSection_default_instance_);_Road_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Road_default_instance_);_BoundaryEdge_default_instance_._instance.get_mutable()->curve_ = const_cast< ::apollo::hdmap::Curve*>(
      ::apollo::hdmap::Curve::internal_default_instance());
  _RoadBoundary_default_instance_._instance.get_mutable()->outer_polygon_ = const_cast< ::apollo::hdmap::BoundaryPolygon*>(
      ::apollo::hdmap::BoundaryPolygon::internal_default_instance());
  _RoadROIBoundary_default_instance_._instance.get_mutable()->id_ = const_cast< ::apollo::hdmap::Id*>(
      ::apollo::hdmap::Id::internal_default_instance());
  _RoadSection_default_instance_._instance.get_mutable()->id_ = const_cast< ::apollo::hdmap::Id*>(
      ::apollo::hdmap::Id::internal_default_instance());
  _RoadSection_default_instance_._instance.get_mutable()->boundary_ = const_cast< ::apollo::hdmap::RoadBoundary*>(
      ::apollo::hdmap::RoadBoundary::internal_default_instance());
  _Road_default_instance_._instance.get_mutable()->id_ = const_cast< ::apollo::hdmap::Id*>(
      ::apollo::hdmap::Id::internal_default_instance());
  _Road_default_instance_._instance.get_mutable()->junction_id_ = const_cast< ::apollo::hdmap::Id*>(
      ::apollo::hdmap::Id::internal_default_instance());
}
...
BoundaryEdge::BoundaryEdge()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5froad_2eproto::InitDefaults();
  }
  SharedCtor();
