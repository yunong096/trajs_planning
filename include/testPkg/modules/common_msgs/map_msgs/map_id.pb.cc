...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/map_msgs/map_id.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Id_default_instance_._instance.DefaultConstruct();
...
Id::Id()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fid_2eproto::InitDefaults();
  }
  SharedCtor();
