...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/map_msgs/map_crosswalk.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Crosswalk_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Crosswalk_default_instance_);_Crosswalk_default_instance_._instance.get_mutable()->id_ = const_cast< ::apollo::hdmap::Id*>(
      ::apollo::hdmap::Id::internal_default_instance());
  _Crosswalk_default_instance_._instance.get_mutable()->polygon_ = const_cast< ::apollo::hdmap::Polygon*>(
...
Crosswalk::Crosswalk()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fcrosswalk_2eproto::InitDefaults();
  }
  SharedCtor();
