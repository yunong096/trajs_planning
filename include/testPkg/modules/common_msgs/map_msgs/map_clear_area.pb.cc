...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/map_msgs/map_clear_area.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
ClearArea::ClearArea()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fclear_5farea_2eproto::InitDefaults();
  }
  SharedCtor();
