...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/map_msgs/map_speed_bump.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
SpeedBump::SpeedBump()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fspeed_5fbump_2eproto::InitDefaults();
  }
  SharedCtor();
