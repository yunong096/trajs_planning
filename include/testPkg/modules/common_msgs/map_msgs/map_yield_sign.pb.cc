...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "modules/common_msgs/map_msgs/map_yield_sign.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  _YieldSign_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_YieldSign_default_instance_);_YieldSign_default_instance_._instance.get_mutable()->id_ = const_cast< ::apollo::hdmap::Id*>(
...
YieldSign::YieldSign()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fyield_5fsign_2eproto::InitDefaults();
  }
  SharedCtor();
